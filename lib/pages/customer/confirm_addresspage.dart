                  ...
                  children: [
                    ...
                    ToggleButtons(
                        ...
                        onPressed: (value) {
                          ...
                          customerController.setAddressType(addresstypes[ConfirmAddressPage.temp[index]].toUpperCase(),
          ...
          if (index == 0) {
            ...
            switch (label) {
              case "Appartment/Complex Name":
                ...
                break;
              case "Flat Number":
                customerController.addAddress1.apartment = value;
                break;
              case "House Number":
                customerController.addAddress1.address2 = customerController.addAddress.address1;
                customerController.addAddress1.address1 = value;
                break;
              case "Landmark":
                customerController.addAddress1.landmark = value;
                break;
            }
          }
        },
